...
# go to https://github.com/zhangxiangxiao/glyph, and download Chinanews
# and rename it to Chinanews_train.csv, and Chinanews_test.csv
...
##Chinese vector, select .bin format, "cc.zh.300.bin' and unzip it.
...
randomCV = RandomizedSearchCV(SVC(kernel='rbf', ), param_distributions=hyperparameters, n_iter=5)
...
import pickle
filename = 'svm_word2vec_segmented_model.sav'
...
df.to_csv('classification_report_svm_word2vec_segmented.csv', index = True)
...
disp.figure_.savefig('confusion_matrix_svm_word2vec_segmented.png')
