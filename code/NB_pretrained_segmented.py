...
import pickle
filename = 'nb_pretrained_segmented_model.sav'
...
df.to_csv('classification_report_nb_pretrained_segmented.csv', index = True)
...
disp.plot()
disp.figure_.savefig('confusion_matrix_nb_pretrained_segmented.png')
