...
sentence_vec_train = [model.get_sentence_vector(sen) for sen in train_content]
sentence_vec_test = [model.get_sentence_vector(sen) for sen in test_content]
# classification
...
randomCV = RandomizedSearchCV( LogisticRegression(),  param_distributions=hyperparameters, n_iter=5)
...
disp.figure_.savefig('confusion_matrix_LR_pretrained_sentence.png')
